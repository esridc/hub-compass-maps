import{l0 as e,C as t,w as o,x as i,y as n,ah as r,a4 as a,mQ as s,mw as c,et as l,dz as h,mU as u,mR as d,m2 as v,nB as f,d$ as m,c as p,kI as g,cq as x,d7 as b,cr as w,as as M,dv as C,ck as T,d6 as y,dy as S,mZ as A,a7 as _,mI as E,lM as O,nW as R,lN as I,lQ as L,aO as F,nO as z,nX as G,B as N,bH as D,s as P,ec as B,ei as H,t as j,fU as V,dc as U,cl as W,c8 as $,cn as k,ft as q,de as Y,kY as J,jj as X,nc as Z,fR as K,hh as Q,di as ee,nY as te,ci as oe,bG as ie,nZ as ne,n_ as re,ce as ae,mG as se,a8 as ce,n$ as le,df as he,dg as ue,dX as de,mT as ve,o0 as fe,o1 as me,aY as pe,a_ as ge,ak as xe,k8 as be,o2 as we,o3 as Me,es as Ce,f6 as Te,a$ as ye,nf as Se,ng as Ae,at as _e,lP as Ee,cf as Oe}from"./p-c9c64150.js";import{t as Re}from"./p-4a3388e8.js";import{s as Ie,i as Le,a as Fe,O as ze,e as Ge,n as Ne,u as De}from"./p-dc92c2ea.js";import{s as Pe}from"./p-0da99933.js";import{H as Be}from"./p-fb9b598f.js";import{b as He,c as je,t as Ve,S as Ue,n as We,u as $e,d as ke,o as qe,r as Ye}from"./p-8ebada6f.js";import{o as Je,t as Xe,r as Ze}from"./p-dddb66c6.js";import{e as Ke}from"./p-e91c4d32.js";import{a as Qe}from"./p-17d8c81f.js";import"./p-07745510.js";import{E as et,U as tt}from"./p-fd436770.js";import{B as ot,o as it,g as nt,c as rt,p as at,r as st,b as ct,d as lt,f as ht}from"./p-94799e63.js";import{e as ut,o as dt}from"./p-79c28fb7.js";import{e as vt,o as ft}from"./p-88dd7081.js";import{I as mt,L as pt}from"./p-70309127.js";import{x as gt,c as xt,y as bt,u as wt,q as Mt,i as Ct}from"./p-94b00c46.js";function Tt(t,o=!1){return t<=e?o?new Array(t).fill(0):new Array(t):new Float32Array(t)}function yt(e){e.vertex.code.add(Je`
  ...
  `)}class St{constructor(e,t,o,i,n=null){if(this.name=e,this.type=t,this.arraySize=n,this.bind={[Qe.Pass]:null,[Qe.Draw]:null},i)switch(o){case Qe.Pass:this.bind[Qe.Pass]=i;break;case Qe.Draw:this.bind[Qe.Draw]=i}}equals(e){return this.type===e.type&&this.name===e.name&&this.arraySize===e.arraySize}}class At extends St{constructor(e,t){super(e,"sampler2D",Qe.Draw,((o,i,n)=>o.bindTexture(e,t(i,n))))}}function _t(){return!!t("enable-feature:objectAndLayerId-rendering")}function Et({code:e},t){t.doublePrecisionRequiresObfuscation?e.add(Je`vec3 dpPlusFrc(vec3 a, vec3 b) {
...
return proj * (view * vec4(pos, 1.0));
    ...
    }`)}const si=a();class ci extends St{constructor(e,t){super(e,"int",Qe.Pass,((o,i,n)=>o.setUniform1i(e,t(i,n))))}}function li(e,t){t.hasSymbolColors?(e.include(yt),e.attributes.add(Ke.SYMBOLCOLOR,"vec4"),e.varyings.add("colorMixMode","mediump float"),e.vertex.code.add(Je`int symbolColorMixMode;
vec4 getSymbolColor() {
...
}`)}function fi(e){e.uniforms.add(new Rt("screenSizePerspective",(e=>pi(e.screenSizePerspective))))}function mi(e){e.uniforms.add(new Rt("screenSizePerspectiveAlignment",(e=>pi(e.screenSizePerspectiveAlignment||e.screenSizePerspective))))}function pi(e){return h(gi,e.parameters.divisor,e.parameters.offset,e.minScaleFactor)}const gi=a();class xi extends St{constructor(e,t){super(e,"vec4",Qe.Pass,((o,i,n)=>o.setUniform4fv(e,t(i,n))))}}function bi(e,t){const o=e.vertex;t.hasVerticalOffset?(Mi(o),t.hasScreenSizePerspective&&(e.include(vi),mi(o),Qo(e.vertex,t)),o.code.add(Je`
...
}`)}function yi(e,t){switch(t.output){case We.Shadow:case We.ShadowHighlight:case We.ShadowExcludeHighlight:case We.ViewshedShadow:e.fragment.include(Ti),e.fragment.code.add(Je`float _calculateFragDepth(const in float depth) {
...
}`)}}class Si extends St{constructor(e,t){super(e,"ivec2",Qe.Pass,((o,i,n)=>o.setUniform2iv(e,t(i,n))))}}class Ai extends St{constructor(e,t){super(e,"sampler2D",Qe.Pass,((o,i,n)=>o.bindTexture(e,t(i,n))))}}function _i(e,t){const{fragment:o}=e;t.output===We.Highlight?(o.uniforms.add(new Ai("depthTexture",((e,t)=>t.mainDepth)),new Ai("highlightTexture",((e,t)=>t.highlightMixTexture)),new ci("highlightLevel",((e,t)=>t.highlightLevel)),new Si("highlightMixOrigin",((e,t)=>t.highlightMixOrigin))),e.outputs.add("fragHighlight","vec2",0),o.code.add(Je`vec2 getAccumulatedHighlight() {
...
forwardTextureCoordinates();`),e.include(Gi,t),i.main.add(Je`
          ...
          ${Ze(n,Je`vec4 texColor = texture(tex, ${s?"colorUV":"vuv0"});
                 discardOrAdjustAlpha(texColor);`)}`);break;case We.Shadow:case We.ShadowHighlight:case We.ShadowExcludeHighlight:case We.ViewshedShadow:case We.ObjectAndLayerIdColor:ei(o,t),e.include(Zo,t),e.include(ui,t),e.include(zi,t),e.include(yi,t),e.include(Ho,t),e.include(Ci,t),No(e),e.varyings.add("depth","float"),n&&i.uniforms.add(new Ai("tex",(e=>e.texture))),o.main.add(Je`vpos = getVertexInLocalOriginSpace();
vpos = subtractOrigin(vpos);
vpos = addVerticalOffset(vpos, localOrigin);
...
return outColor;
}`);break;default:case $n.COUNT:}}class sr extends St{constructor(e,t,o){super(e,"mat4",Qe.Draw,((o,i,n,r)=>o.setUniformMatrix4fv(e,t(i,n,r))),o)}}class cr extends St{constructor(e,t,o){super(e,"mat4",Qe.Pass,((o,i,n)=>o.setUniformMatrix4fv(e,t(i,n))),o)}}function lr(e,t){t.receiveShadows&&(e.fragment.uniforms.add(new cr("shadowMapMatrix",((e,t)=>t.shadowMap.getShadowMapMatrices(e.origin)),4)),ur(e))}function hr(e,t){t.receiveShadows&&(e.fragment.uniforms.add(new sr("shadowMapMatrix",((e,t)=>t.shadowMap.getShadowMapMatrices(e.origin)),4)),ur(e))}function ur(e){const t=e.fragment;t.include(Ti),t.uniforms.add(new Ai("shadowMap",((e,t)=>t.shadowMap.depthTexture)),new ci("numCascades",((e,t)=>t.shadowMap.numCascades)),new xi("cascadeDistances",((e,t)=>t.shadowMap.cascadeDistances))).code.add(Je`int chooseCascade(float depth, out mat4 mat) {
